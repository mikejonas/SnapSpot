...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (photo.asset.defaultRepresentation.metadata[@"{GPS}"] != NULL) {
        cell.locationIconImageView.image = [UIImage imageNamed:@"Location Found"];
    } else {
        cell.locationIconImageView.image = nil;
    }
